...
// of each resource types by time unit.  The second dimension is the resource
// Id while the 3rd is the resource ndx.
func (pln *Planner) MakeCostsByProjByResourceByTimeUnit(timeDivisor int) [][][]float32 {
...
func (pln *Planner) CostsByProjByResRep(sheetName string, timeDivisor int, timeDivisorYear int, divLabel string) {
